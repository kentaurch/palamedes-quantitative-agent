# Palamedes — Quantitative Analysis Agent

Part of the **Telos Trading Council** — a team of six specialized AI agents for crypto futures trading.

## Overview

Palamedes is a specialized analysis agent within the Telos Trading Council, focusing on quantitative analysis. It works alongside five other agents to provide a comprehensive, multi-perspective analysis of the crypto markets.
...
| Script | Purpose |
|--------|---------|
| `palamedes-data.py` | Data collection & analysis pipeline |
| `portfolio_construction.py` | Data collection & analysis pipeline |
| `walkforward_opt.py` | Data collection & analysis pipeline |
...
```bash
cd scripts/
python3 palamedes-data.py --json
```
...
*Part of the Telos ecosystem — quantitative analysis intelligence for crypto futures trading.*
